...
def build_report():
    ...
    if scout_synergy:
        ...
        best_before = (
            scout_synergy["best_before"]
        )

        best_after = (
            scout_synergy["best_after"]
        )
    ...
    if result["user_gain"] < 0:
        lines.append(
            "❌ Lo scambio peggiora "
            "la struttura della rosa."
        )

    elif result["user_gain"] < 0.25:
        lines.append(
